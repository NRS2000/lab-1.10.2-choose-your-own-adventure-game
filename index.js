...
if(firstAnswer === 'left'){
    ...
    if(secondAnswer === 'follow'){
        ...
        in a fort of warm blankets and subsisting off of inexplicably warm soup. They 
        are content with you staying, but you wonder if you should alert the world to this magical safe haven.`)
        if(thirdAnswer === 'stay'){
            ...
            let fourthAnswer = window.prompt(`After leaving the cat colony, you are never able to find it 
        ...
        if(thirdAnswer === 'ladder'){
            let fourthAnswer = window.prompt(`After ascending a few feet up the ladder, one of its rungs snaps, 
            and you comedically fall through each of the rungs below. Sheepish, you return home.`)
        }
        else if(thirdAnswer === 'staircase'){
            let fourthAnswer = window.prompt(`After ascending the staircase, you discover a shiny blue stone, 
    ...
    if (secondAnswer === 'past the dragon'){
        ...
        if(thirdAnswer === 'stay'){
            let fourthAnswer = window.prompt(`You and the dragon have an uplifting 
        ...
        if(thirdAnswer === 'draw it'){
            let fourthAnswer = window.prompt(`You draw the flower, capturing only a fraction of 
            its beauty with your quill. You bring the drawing home, somewhat disappointed, but over 
            time, discover joy in sharing it with your friends and family, recounting the story of your 
            days as a sorcerer with the aid of the sketch.`)
        }
        else if(thirdAnswer === 'pick it'){
            let fourthAnswer = window.prompt(`You pick the flower and bring it home, and all marvel 
